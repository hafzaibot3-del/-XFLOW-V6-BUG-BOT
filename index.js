...
const { color } = require('./xflow/lib/color');
const { smsg, sleep, getBuffer } = require('./xflow/lib/myfunction');
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid, addExif } = require('./xflow/lib/exif')
...
const clientstart = async() => {
    ...
    client.ev.on('connection.update', (update) => {
        const { konek } = require('./xflow/lib/connection/connect')
